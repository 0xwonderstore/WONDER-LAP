...
import { Moon, Sun, Sparkles, Heart, LayoutDashboard, ShieldCheck } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const { keywords: blacklistedKeywords } = useBlacklistStore();
  ...
  const filteredProducts = useMemo(() => {
    return filterProducts(allProducts, blacklistedKeywords);
  }, [allProducts, blacklistedKeywords]);
