...
const DashboardSettings = () => {
  ...
  const columnLabels = {
    ...
    newProducts60d: t.dashboard_newProducts60d_store,
    newProducts90d: t.dashboard_newProducts90d_store,
    newProducts180d: t.dashboard_newProducts180d_store,
    newProducts30dPercentage: t.dashboard_newProducts30d_percentage_store,
    newProducts60dPercentage: t.dashboard_newProducts60d_percentage_store,
    newProducts90dPercentage: t.dashboard_newProducts90d_percentage_store,
    newProducts180dPercentage: t.dashboard_newProducts180d_percentage_store,
    activityRate30d: t.dashboard_activityRate30d,
    activityRate60d: t.dashboard_activityRate60d,
    activityRate90d: t.dashboard_activityRate90d,
    activityRate180d: t.dashboard_activityRate180d,
