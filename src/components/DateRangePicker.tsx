    ...
    <div className="relative w-full h-full" ref={wrapperRef}>
      ...
      >
        <div className="flex items-center gap-2 overflow-hidden">
            <div className="text-gray-400 dark:text-gray-500 group-hover:text-purple-500 transition-colors">
                 {/* Replaced Icon with text or kept minimal if icon is in label */}
            </div>
          ...
          <div className="flex-1 p-2 sm:p-4 bg-white dark:bg-gray-800">
            <DayPicker
              ...
              classNames={{
                ...
                cell: 'text-center text-sm p-0 relative [&:has([aria-selected])]:bg-purple-50 dark:[&:has([aria-selected])]:bg-purple-900/20 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20',
                ...
                day_selected: '!bg-purple-500 !text-white hover:!bg-purple-600 hover:!text-white shadow-md shadow-purple-500/30',
                day_today: 'bg-gray-100 dark:bg-gray-700 text-purple-600 dark:text-purple-300 font-bold border border-gray-200 dark:border-gray-600',
                ...
                day_range_start: '!bg-purple-500 !text-white !rounded-l-md !rounded-r-none',
                day_range_end: '!bg-purple-500 !text-white !rounded-r-md !rounded-l-none',
