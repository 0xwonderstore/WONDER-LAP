...
import { Search, Store, Calendar, LayoutGrid, List, X, ListFilter } from 'lucide-react';
...
function FilterPanel({
  ...
  const isAnyFilterActive = filters.title || filters.vendor || (filters.dateRange && filters.dateRange !== 'all');
