  ...
  return (
    <div className="animate-fade-in-up space-y-8">
      ...
      <div className="border-b border-light-border dark:border-dark-border flex space-x-4">
        <Tab id="stores" icon={<Store size={18}/>} label={t.stores} activeTab={activeTab} setActiveTab={setActiveTab} />
        <Tab id="languages" icon={<LanguagesIcon size={18}/>} label={t.languages} activeTab={activeTab} setActiveTab={setActiveTab} />
...
const Tab: React.FC<{id: ActiveTab; icon: React.ReactNode; label: string; activeTab: ActiveTab; setActiveTab: (tab:ActiveTab)=>void}> = ({ id, icon, label, activeTab, setActiveTab }) => (
    <button 
